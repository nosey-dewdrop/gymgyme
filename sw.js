...
const CACHE = "gg-pwa-v81";  // v81: fix figure freeze (MOVES->POSES undefined), pink back (peach removed), nowhere/output left/right asymmetry, three-jobs narrow, ambient two-layer
