...
Run on every deploy so new pages get indexed automatically. No manual work.

Rules:
- one <url> per .html file (index.html -> the directory URL, no filename)
- priority by section, changefreq by how often it moves
- lastmod = file mtime
- skips non-indexable pages (404, noindex) and non-page dirs (mockups,
  partials, tools, vendor)
"""
import os, re, datetime

WEB = os.path.dirname(os.path.abspath(__file__))
DOMAIN = "https://gymgyme.noseydewdrop.com"
